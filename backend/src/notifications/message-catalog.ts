...
export const MESSAGE_CATALOG: MessageDef[] = [
  // ---- Customer-facing --------------------------------------------------------
  {
    ...
    hint: "Sent by SMS the moment the driver taps I'm on the Way. Editable separately from the email below.",
  ...
  },
  {
    ...
    hint: "Sent by email the moment the driver taps I'm on the Way. Editable separately from the SMS above.",
