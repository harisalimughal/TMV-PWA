...
/**
 * Reminds a driver by push shortly before (TMV_JOB_REMINDER_LEAD_MS, default 1 hour)
 * a job they're assigned to is due to start. Runs on the same kind of plain
